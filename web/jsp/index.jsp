...
<form action="${pageContext.request.contextPath}/payments" id="login-form" method="post">
    <div class="login">
...
<div class="link">
    <a href="<c:url value="/jsp/user/registration.jsp"/>" id="regLink" data-hover="<fmt:message key="REGISTRATION"/>">
